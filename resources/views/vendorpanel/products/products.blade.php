    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head nk-block-head-sm nk-block col-xxl-8" style="margin-top: 3rem">
            <div class="nk-block-between">
                ...
                <div class="nk-block-head-content">
                    <a href="{{ route('addvendorproducts') }}" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                    <a href="{{ route('addvendorproducts') }}" class="btn btn-outline-info d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Product</span></a>
                </div><!-- .nk-block-head-content -->
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    <li><a href="{{ route('editvendorproduct',$product->id) }}"><em class="icon ni ni-edit"></em><span>Update Product</span></a></li>
                                                    <li><a href="#"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
                                                    <li>
                                                        <a href="{{ route('deletevendorproduct',$product->id) }}"><em class="icon ni ni-trash"></em><span>Remove Product</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
