            ...
            <section class="py-3 border-bottom d-none d-md-flex">
                <div class="container">
                    <div class="page-breadcrumb d-flex align-items-center">
                        <h3 class="breadcrumb-title pe-3">{{ $product->brand->brand }} {{ $product->productname }}</h3>
                        <div class="ms-auto">
                            ...
                            <div class="row g-0">
                                    ...
                                    <div class="image-zoom-section">
                                        ...
                                        <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
                                            <button class="owl-thumb-item">
                                                <img src="{{ asset('products/'.$product->image) }}" class="" alt="">
                                            </button>
                                            <button class="owl-thumb-item">
                                                <img src="{{ asset('products/'.$product->image) }}" class="" alt="">
                                            </button>
                                ...
                                <div class="col-12 col-lg-7">
                                    <div class="product-info-section p-3">
                                        <h3 class="mt-3 mt-lg-0 mb-0">{{ $product->brand->brand }}</h3>
                                        {{-- <h3 class="mt-3 mt-lg-0 mb-0">{{ $product->category->category }}</h3> --}}
                                        <h4 class="mt-3 mt-lg-0 mb-0">{{ $product->productname }}</h4>
                                        ...
                                        <div class="d-flex align-items-center mt-3 gap-2">
                                            ...
                                            <h4 class="mb-0">PKR: {{ $product->unitprice }}</h4>
                                        </div>
                                        <div class="mt-3">
                                            <h6>Discription :</h6>
                                        ...
                                        <div class="d-flex gap-2 mt-3">
                                                ...
                                                <button type="submit" class="btn btn-white btn-ecomm"><i class="bx bxs-cart-add"></i>Add to Cart</button> 
                                            
                                            <button class="btn btn-light btn-ecomm"><i class="bx bx-heart"></i>Add to Wishlist</button>
                                        </div>
                                        </form>
                                        <hr/>
