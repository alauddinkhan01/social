                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding-bottom:25px">
                                    <a href="#"><img style="height: 40px" src=""></a>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    <p style="margin-bottom: 10px;"><strong>Hello {{ Auth::user()->name }}</strong>,</p>
                                    <p style="margin-bottom: 10px;">A New Brand <strong> "{{ $category}}"</strong> added successfully</p>
                                    ...
                                    <p style="margin-bottom: 15px;">.If you have any kind of complaints or suggessions please email us on {{ Auth::user()->email }}</p>
                                    <p style="margin-top: 35px; margin-bottom: 15px;">----<br>Regards<br>{{ Auth::user()->name }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
