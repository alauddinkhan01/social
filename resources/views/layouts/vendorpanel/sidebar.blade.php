            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{ route('vendorpanel') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-dashboard"></em></span>
                            <span class="nk-menu-text">Dashboard</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="{{ route('vendorsorders') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-cart"></em></span>
                            <span class="nk-menu-text">Orders</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    {{-- <li class="nk-menu-item">
                        <a href="{{ route('totalsales') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-network"></em></span>
                            <span class="nk-menu-text">sales</span>
                        </a>
                    </li> --}}
                    {{-- <li class="nk-menu-item">
                        <a href="{{ route('vendororders') }}" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{ route('vendorproducts',Auth::user()->vendor->id) }}" class="nk-menu-link">
