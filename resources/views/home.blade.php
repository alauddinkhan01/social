...
@section('content')
<a class="btn btn-outline-info" href="{{ route('dashboard') }}">Dashboard</a>
<div class="container">
											...
											<div class="card-body">
												<div class="list-group list-group-flush">	<a href="account-dashboard.html" class="list-group-item active d-flex justify-content-between align-items-center">Dashboard <i class='bx bx-tachometer fs-5'></i></a>
                                                    ...
                                                    <form id="logout-form" action="{{ route('logout') }}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        {{-- <a href="" type="submit" class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Logout <i class='bx bx-log-out fs-5'></i></a> --}}
                                                        <button type="submit" class="btn btn-outline-info btn-ecomm d-flex justify-content-between">logout<i class='bx bx-log-out fs-5'></i></button>
                                                    </form>
												</div>
											</div>
										</div>
