								...
								<div class="col">
									<div class="card rounded-0 product-card">
										...
										<a href="{{ route('productdetails',$products->id) }}">
											<img src="{{ asset('products/'.$products->image) }}" class="card-img-top" alt="...">
										</a>
										<div class="card-body">
											<div class="product-info">
												<a href="javascript:;">
													<p class="product-catergory font-13 mb-1">{{ $products->category->category}}</p>
												</a>
												<a href="javascript:;">
													<h6 class="product-name mb-2">{{ $products->productname}}</h6>
												</a>
												<div class="d-flex align-items-center">
													<div class="mb-1 product-price"> <span class="me-1 text-decoration-line-through"></span>
														<span class="text-white fs-5">PKR:{{ $products->unitprice}}</span>
													</div>
													<div class="cursor-pointer ms-auto"> <i class="bx bxs-star text-white"></i>
														<i class="bx bxs-star text-white"></i>
														<i class="bx bxs-star text-white"></i>
												...
												<div class="product-action mt-2">
													<div class="d-grid gap-2">
														<a href="{{ route('productdetails',$products->id) }}" class="btn btn-light btn-ecomm"> <i class='bx bxs-cart-add'></i>Add to Cart</a> <a href="javascript:;" class="btn btn-link btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i class='bx bx-zoom-in'></i>Quick View</a>
													</div>
												</div>
											</div>
										</div>
							...
							@foreach ($newarrival as $newarrival)
								<div class="item">
									<div class="card rounded-0 product-card">
										...
										<a href="{{ route('productdetails',$newarrival->id) }}">
											<img src="{{ asset('products/'.$newarrival->image) }}" class="card-img-top" alt="...">
										</a>
										<div class="card-body">
											<div class="product-info">
												<a href="javascript:;">
													<p class="product-catergory font-13 mb-1">{{ $newarrival->category->category }}</p>
												</a>
												<a href="javascript:;">
													<h6 class="product-name mb-2">{{ $newarrival->productname }}</h6>
												</a>
												<div class="d-flex align-items-center">
													<div class="mb-1 product-price"> <span class="me-1 text-decoration-line-through"></span>
														<span class="text-white fs-5">PKR:{{ $newarrival->unitprice }}</span>
													</div>
												...
												<div class="product-action mt-2">
													<div class="d-grid gap-2">
														<a href="{{ route('productdetails',$newarrival->id) }}" class="btn btn-light btn-ecomm"> <i class='bx bxs-cart-add'></i>Add to Cart</a> <a href="javascript:;" class="btn btn-link btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i class='bx bx-zoom-in'></i>Quick View</a>
													</div>
												</div>
											</div>
										</div>
				...
				<div class="container">
					...
					<div class="product-grid">
						<div class="browse-category owl-carousel owl-theme">
							@foreach ($browseproducts as $browseproducts)
								<div class="item">
									<div class="card rounded-0 product-card border">
										<div class="card-body">
											<a href="{{ route('productdetails',$browseproducts->id) }}">
												<img src="{{ asset('products/'.$browseproducts->image) }}" class="img-fluid" alt="...">
											</a>
										</div>
										<div class="card-footer text-center">
											<h6 class="mb-1 text-uppercase">{{ $browseproducts->category->category }}</h6>
											<p class="mb-0 font-12 text-uppercase">{{ $browseproducts->quantity }} Products</p>
										</div>
									</div>
								</div>
							@endforeach
					...
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 row-group">
						...
						<div class="col">
							<div class="text-center">
								...
								<p class="text-capitalize">We possess SSL / Secure certificate</p>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec vestibulum magna, et dapib.</p>
							</div>
						</div>
						<div class="col">
			...
			<section class="py-4 border-top">
				<div class="container">
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
								...
								@foreach ($bestselling as $bestselling)
									<div class="d-flex align-items-center">
										<div class="bottom-product-img">
											<a href="{{ route('productdetails',$bestselling->id) }}">
												<img src="{{ asset('products/'.$bestselling->image) }}" width="100" alt="">
											</a>
										</div>
										<div class="ms-0">
											<h6 class="mb-0 fw-light mb-1">{{ $bestselling->productname }}</h6>
											...
											<p class="mb-0 text-white"><strong>{{ $bestselling->unitprice }}PKR</strong>
											</p>
										</div>
									</div>
								<hr/>
						...
						<div class="col">
							<div class="featured-list mb-3">
								...
								@foreach ($featureproducts as $featureproducts)
									<div class="d-flex align-items-center">
									<div class="bottom-product-img">
										<a href="{{ route('productdetails',$featureproducts->id) }}">
											<img src="{{ asset('products/'.$featureproducts->image) }}" width="100" alt="">
										</a>
									</div>
									<div class="ms-0">
										<h6 class="mb-0 fw-light mb-1">{{ $featureproducts->productname }}</h6>
										...
										<p class="mb-0 text-white"><strong>{{ $featureproducts->unitprice }}PKR</strong>
										</p>
									</div>
									</div>
									<hr/>
						...
						<div class="col">
							<div class="featured-list mb-3">
								<h6 class="mb-3 text-uppercase">New Products</h6>
								@foreach ($newproducts as $newproducts)
									<div class="d-flex align-items-center">
									<div class="bottom-product-img">
										<a href="{{ route('productdetails',$newproducts->id) }}">
											<img src="{{ asset('products/'.$newproducts->image) }}" width="100" alt="">
										</a>
									</div>
									<div class="ms-0">
										<h6 class="mb-0 fw-light mb-1">{{ $newproducts->name }}</h6>
										<div class="rating font-12"> <i class="bx bxs-star text-white"></i>
											<i class="bx bxs-star text-white"></i>
											<i class="bx bxs-star text-white"></i>
											<i class="bx bxs-star text-white"></i>
										...
										<p class="mb-0 text-white"><strong>{{ $newproducts->unitprice }}PKR</strong>
										</p>
									</div>
									</div>
									<hr/>
						...
						<div class="col">
							<div class="featured-list mb-3">
								<h6 class="mb-3 text-uppercase">Discounted Products</h6>
								@foreach ($discountproducts as $discountproducts)
									<div class="d-flex align-items-center">
									<div class="bottom-product-img">
										<a href="{{ route('productdetails',$discountproducts->id) }}">
											<img src="{{ asset('products/'.$discountproducts->image) }}" width="100" alt="">
										</a>
									</div>
									<div class="ms-0">
										<h6 class="mb-0 fw-light mb-1">{{ $discountproducts->productname }}</h6>
										<div class="rating font-12"> <i class="bx bxs-star text-white"></i>
											<i class="bx bxs-star text-white"></i>
											<i class="bx bxs-star text-white"></i>
											<i class="bx bxs-star text-white"></i>
										...
										<p class="mb-0 text-white"><strong>{{ $discountproducts->unitprice }}PKR</strong>
										</p>
									</div>
									</div>
									<hr/>
					...
					<div class="row g-0">
						<div class="col-12 col-lg-6">
							<div class="image-zoom-section">
								<div class="product-gallery owl-carousel owl-theme border mb-3 p-3" data-slider-id="1">
									<div class="item">
										<img src="{{ asset('products/'.$products->image) }}" class="img-fluid" alt="">
									</div>
									<div class="item">
										<img src="{{ asset('products/'.$products->image) }}" class="img-fluid" alt="">
									</div>
								...
								<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
									<button class="owl-thumb-item">
										<img src="{{ asset('products/'.$products->image) }}" class="" alt="">
									</button>
									<button class="owl-thumb-item">
										<img src="{{ asset('products/'.$products->image) }}" class="" alt="">
									</button>
						...
						<div class="col-12 col-lg-6">
							<div class="product-info-section p-3">
								<h3 class="mt-3 mt-lg-0 mb-0">{{ $products->productname }}</h3>
								...
								<div class="d-flex align-items-center mt-3 gap-2">
									...
									<h4 class="mb-0">{{ $products->unitprice }}PKR</h4>
								</div>
								<div class="mt-3">
									<h6>Discription :</h6>
	...
	{{-- <script>
		$(document).ready(function(){
			$('#QuickViewProduct').click(function(){
                ...
                var url = '{{ route("getdetails", ":products->id") }}';
