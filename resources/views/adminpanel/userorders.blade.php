                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-tnx">
                        <div class="nk-tb-item nk-tb-head">
                            <div class="nk-tb-col"><span>Product Name</span></div>
                            <div class="nk-tb-col tb-col-md"><span>Product Price</span></div>
                            <div class="nk-tb-col"><span class="d-none d-mb-block">Quantity</span></div>
                            <div class="nk-tb-col tb-col-sm"><span>Total Price</span></div>
                            <div class="nk-tb-col tb-col-md"><span>Ordered Date</span></div>                            <div class="nk-tb-col nk-tb-col-tools">
                        ...
                        @foreach ($orders as $order)
                            ...
                            <div class="nk-tb-col">
                                <span class="tb-lead">{{ $order->product->productname }}</span>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <span class="tb-sub">{{ $order->product_price }}</span>
                            </div>
                            <div class="nk-tb-col">
                            ...
                            <div class="nk-tb-col tb-col-sm">
                                <span class="tb-sub">{{ $order->total_price }}</span>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <span class="tb-sub text-primary">{{ $order->created_at }}</span>
                            </div>
