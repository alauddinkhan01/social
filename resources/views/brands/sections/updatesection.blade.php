...
<div class="col-sm-12 col-md-12 col-lg-12 col-xxl-12">
    <div class="nk-block-head-content nk-block-head nk-block-head-sm nk-block col-xxl-8" style="margin-top: 1.5rem">
        <h3 class="nk-block-title page-title">Update Section</h3>
    </div><!-- .nk-block-head-content -->
    <div class="nk-block-head nk-block-head-sm nk-block col-xxl-8">
        <form action="{{ route('updatesection',$section->id) }}" method="post" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input required value="{{ $section->section }}" type="text" name="section" class="form-control form-control-xl form-control-outlined" id="section">
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <select name="status" class="form-select form-control form-control-xl" data-ui="xl" id="status">
                                            ...
                                            <option value="Inactive"{{ $section->status=='Inactive'?'selected':'' }}>In Active</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <select name="brand_id" class="form-select form-control form-control-xl" data-ui="xl" id="brand_id">
                                            ...
                                            <option value="{{ $brand->id }}"{{ $section->brand_id==$brand->id?'selected':'' }} >{{ $brand->brand }}</option>
                                            @endforeach
                                        </select>
