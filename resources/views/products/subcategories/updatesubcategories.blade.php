...
<div class="col-sm-12 col-md-12 col-lg-12 col-xxl-12">
    <div class="nk-block-head-content nk-block-head nk-block-head-sm nk-block col-xxl-8" style="margin-top: 1.5rem">
        <h3 class="nk-block-title page-title">Update Sub Category</h3>
    </div><!-- .nk-block-head-content -->
    <div class="nk-block-head nk-block-head-sm nk-block col-xxl-8">
        <form action="{{ route('updatesubcategories',$subcategory->id) }}" method="post" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input required value="{{ $subcategory->subcategory }}" type="text" name="subcategory" class="form-control form-control-xl form-control-outlined" id="name">
