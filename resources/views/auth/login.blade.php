                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                <div class="brand-logo pb-5">
                                    <a href="html/index.html" class="logo-link">
                                        {{-- <img class="logo-light logo-img logo-img-lg" src="{{ asset ('adminpanel/images/logo.png') }}" srcset="./images/logo2x.png 2x" alt="logo">
                                        <img class="logo-dark logo-img logo-img-lg" src="{{ asset('adminpanel/images/logo-dark.png') }}" srcset="./images/logo-dark2x.png 2x" alt="logo-dark"> --}}
                                    </a>
                                </div>
                                ...
                                <form  method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email"  value="{{ old('email') }}" id="email" placeholder="Enter your email address or username"  required autocomplete="email" autofocus>
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <ul class="nav justify-center gx-4">
                                    <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/" target="blank">Facebook</a></li>
                                    <li class="nav-item"><a class="nav-link" href="https://www.google.com/" target="blank">Google</a></li>
                                </ul>
